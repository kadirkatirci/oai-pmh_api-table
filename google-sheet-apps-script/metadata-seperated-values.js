function fetchAndPlaceData() {
    ...
    var spreadsheet = SpreadsheetApp.create("yatay sep2");
    ...
    for (var i = 0; i < records.length; i++) {
      ...
      for (var j = 0; j < metadataChildren.length; j++) {
        ...
        // Check if this header already has a value.
        if (rowData[headers.indexOf(name)]) {
          // Append the new value with "---" separator.
